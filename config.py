...
"Loại giấy tờ": {
  "type": "string",
  "description": "Extract the document type, it usually appears inside the '<section_header_level_1>'. This is usually a large, uppercase phrase at the top of the document, starting with 'GIẤY' (e.g., 'GIẤY CHỨNG SINH', 'GIẤY CHỨNG NHẬN NGHỈ VIỆC HƯỞNG BHXH', 'GIẤY RA VIỆN', 'GIẤY KHAI SINH') ."
},
